...
@WebServlet(name = "movie-search", urlPatterns = "/search")
public class MovieSearchServlet extends HttpServlet {
    private final MovieRepository movieRepository;
    private final SpringTemplateEngine springTemplateEngine;

    public MovieSearchServlet(MovieRepository movieRepository, SpringTemplateEngine springTemplateEngine){
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Movie> searchResults = movieRepository.filterMovies(searchText, searchRating);
